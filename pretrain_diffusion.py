            ...
            if vis:
                ...
                if idx % vis_freq == 0: 
                    ...
                    if align:
                        ...
                        m_final_indices[m_mask] = m_final_indices[m_mask]
                    ...
                    visualize_pose_sequences(ori_pose_sub_vis_norm, ori_pose_sub_vis_norm, pred_pose_sub_vis, motion_max_idx_vis, structure_max_idx_vis, corresponding_frames=corresponding_slice, save_path=file_save_path)
                    ...
                    if render:
                        ...
                        gt_vis,_ = p_mpjpe(gt_vis, predicted_vis)
...
def train_with_config(args_all, args_motionbert):
    ...
    if not args_all.evaluate: 
        ...
        start_time = time()
        epoch_loss_3d_val, N_val = evaluate(args_all, model_pos_test_temp, test_loader, vis=True, vis_freq=1, writer=writer, restore=False, align=True)          
        elapsed = (time() - start_time) / 60
