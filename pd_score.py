...
from test import *
from configs import generate_config_motionbert
...
def parse_args():
    ...
    parser.add_argument('--backbone', type=str, default='D3DP', help='backbone (motionbert only)')
    parser.add_argument('--dataset', type=str, default='3dgait',help='**currently code only works for PD')
    parser.add_argument('--data_path', type=str,default='/opt/data/private/gait/PerNGR/data/motion3d/MB3D_f81s9')
    ...
    parser.add_argument('--last_run_foldnum', default='22', type=str)
    ...
    # Experimental
    parser.add_argument('--feature', default='extracted', type=str, metavar='feature_type',
                        help='extracted or extracted_gt')
    parser.add_argument('-gpu', default='0', type=str, help='assign the gpu(s) to use')
    parser.add_argument('--subset', default=1, type=float, metavar='FRACTION', help='reduce dataset size by fraction')
    parser.add_argument('--task_type', default='subtype', type=str, metavar='task_type',
                        help='pd_score or subtype')
...
if __name__ == '__main__':
    ...
    if param['dataset'] == 'pdgait':
        num_folds = 22
        param['num_classes'] = 3  
    elif param['dataset'] == '3dgait':
        num_folds = 10
        if param['task_type'] == "subtype":
            param['num_classes'] = 3
        else:  
            param['num_classes'] = 4  
    else:
    ...
    if backbone_name == 'motionbert' or backbone_name == 'D3DP':
        conf_path = './configs/pd_score/motionbert/'
    else:
    ...
    # folds_sub_with_0 = [15,17,19,21]
    # folds_sub_wo_0 = [1,5,7,8,9,10,12,13]
