...
def generate_config(param, f_name):
    ...
    model_params = {
        ...
        'temporal_conv': False,
        'joint_conv': False,
        'model_checkpoint_path': f"{path.PRETRAINEDD_MODEL_CHECKPOINTS_ROOT_PATH}/best_epoch.bin"
    }
    learning_params = {
    ...
    f = open("./configs/pd_score/motionbert/" + f_name, "rb")
    ...
    params['model_prefix'] = params['backbone'] + '_' + f_name.split('.json')[0]
