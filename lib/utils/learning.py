...
from lib.model.Partformer import Partformer
...
def load_backbone(args):
    ...
    if args.backbone=='Partformer':
        model_backbone = Partformer(dim_in=3, dim_out=3, dim_feat=args.dim_feat, dim_rep=args.dim_rep, 
